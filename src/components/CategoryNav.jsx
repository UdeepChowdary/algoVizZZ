            ...
            <button
              ...
              className={`p-2.5 rounded-xl border text-left transition-all duration-200 flex flex-col justify-between gap-1.5 ${
                isSelected
                  ...
                  : "bg-slate-900/60 border-slate-800/80 text-slate-300 hover:bg-slate-800/60 hover:text-slate-200 hover:border-slate-700"
              }`}
            >
              <div className="flex items-center justify-between w-full">
                <span className={`text-[10px] font-mono font-semibold px-1.5 py-0.5 rounded ${
                  isSelected ? "bg-indigo-500/20 text-indigo-300" : "bg-slate-800 text-slate-300"
                }`}>
                  {algo.file}
                </span>
                {isSelected && <Sparkles className="w-3 h-3 text-indigo-300 animate-pulse" />}
              </div>
              ...
              <div className="flex items-center justify-between text-[10px] text-slate-300 pt-1 border-t border-slate-800/60 w-full">
