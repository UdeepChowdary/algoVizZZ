  ...
  return (
    <div className="min-h-screen studio-ambient-bg text-slate-200 font-sans flex flex-col justify-between selection:bg-indigo-500 selection:text-white relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col min-h-screen justify-between">
        {/* Home Navigation Bar */}
      <header className="sticky top-0 z-50 backdrop-blur-xl bg-[#090b10]/80 border-b border-white/[0.08] px-4 md:px-8 py-3.5 flex items-center justify-between">
      ...
      <section className="px-4 md:px-8 pt-12 pb-16 max-w-[1400px] mx-auto w-full flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1 flex flex-col gap-6 text-left max-w-2xl">
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            ...
            <a
              href="#algorithms"
              className="px-5 py-3.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-300 border border-slate-800 text-sm font-semibold transition active:scale-95"
            >
              Explore 14+ Algorithms
            </a>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 pt-6 border-t border-slate-800/80 text-xs text-slate-400 font-mono">
            ...
            <div>
              <div className="text-indigo-400 font-bold text-lg font-sans">7</div>
              <div>DSA Categories</div>
            </div>
            <div>
              <div className="text-emerald-400 font-bold text-lg font-sans">100%</div>
              <div>Interactive Execution</div>
            </div>
          </div>
        </div>
      ...
      {/* Feature Bento Grid */}
      <section id="features" className="px-4 md:px-8 py-16 max-w-[1400px] mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="bento">
