...
export default function KnapsackGreedyVisualizer({ step }) {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-6 gap-6 min-h-[320px]">
      ...
      <div className="flex flex-wrap justify-center gap-4">
        {items.map((it, idx) => {
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between font-bold text-sm text-blue-400 border-b border-gray-800 pb-1">
                <span className="flex items-center gap-1">
                  <Package className="w-4 h-4 text-blue-400" /> Item #{it.id}
                </span>
              ...
              <div className="text-purple-300 font-semibold pt-1 border-t border-gray-800">
      ...
      {/* Knapsack Capacity Progress Bar */}
      <div className="w-full max-w-[460px] bg-gray-950 p-4 rounded-xl border border-gray-800 flex flex-col gap-2 font-mono">
        ...
        <div className="w-full h-4 bg-gray-900 rounded-full border border-gray-800 overflow-hidden relative">
          <div
        ...
        <div className="flex justify-between text-[11px] text-gray-500">
          ...
          <span>Current Total Profit: <strong className="text-emerald-400">${step.totalVal?.toFixed(2) || 0}</strong></span>
        </div>
      </div>
    </div>
  );
