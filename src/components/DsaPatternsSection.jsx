          ...
          return (
            ...
            >
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-[10px] font-mono text-slate-400">
                      {pattern.category} • <span className="text-amber-400 font-semibold">{pattern.difficulty}</span>
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-1.5 font-mono text-[10px] shrink-0">
                  <span className="px-2 py-1 rounded bg-amber-500/10 border border-amber-500/20 text-amber-300 font-bold flex items-center gap-1">
                    <Zap className="w-3 h-3 text-amber-400" /> {pattern.timeComplexity}
                  </span>
                  <span className="px-2 py-1 rounded bg-purple-500/10 border border-purple-500/20 text-purple-300 font-bold flex items-center gap-1">
                    <HardDrive className="w-3 h-3 text-purple-400" /> {pattern.spaceComplexity}
                  </span>
                </div>
              </div>
              ...
              <div className="bg-slate-900/80 p-3.5 rounded-xl border border-slate-800/80 flex flex-col gap-1 text-xs">
                <span className="text-[11px] font-mono font-semibold text-amber-400 uppercase tracking-wide flex items-center gap-1">
                  <HelpCircle className="w-3.5 h-3.5 text-amber-400" /> When to Use (Trigger Condition)
                </span>
              ...
              <div className="flex flex-col gap-2.5">
                <span className="text-[11px] font-mono font-semibold text-slate-400 uppercase tracking-wide flex items-center gap-1.5">
